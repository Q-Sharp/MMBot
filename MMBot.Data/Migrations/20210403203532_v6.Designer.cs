...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemberSeason", b =>
                {
                    b.Property<int>("MemberId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("MemberId", "SeasonId");

                    b.HasIndex("SeasonId");

                    b.ToTable("MemberSeason");
                });
            ...
            modelBuilder.Entity("MemberSeason", b =>
                {
                    b.HasOne("MMBot.Data.Entities.Member", null)
                        .WithMany()
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MMBot.Data.Entities.Season", null)
                        .WithMany()
