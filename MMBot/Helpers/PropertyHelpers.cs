            ...
            where T : class
        {
            ...
            try
            {
                ...
                if (pr != null)
                {
                    ...
                    var safeValue = (newValue == null) ? null : newValue.GetType() == typeof(Role) ? Enum.TryParse(newValue.ToString(), out Role eNum) ? eNum : Convert.ChangeType(newValue, t) : Convert.ChangeType(newValue, t);
